    ...
    return (
        <Stack direction={'row'} width={'90vw'} >
            ...
            <Stack direction={'column'} justifyContent={'center'} gap={2}>
                <Button>
                    <ArrowUpwardIcon fontSize='large' sx={{ bgcolor: grey[900], color: 'white', borderRadius: '20px', height: '40px', width: '40px', p: 1 }} />
                </Button>
                <Button>
                    <ArrowDownwardIcon fontSize='large' sx={{ bgcolor: grey[900], color: 'white', borderRadius: '20px', height: '40px', width: '40px', p: 1 }} />
                </Button>
            </Stack>
